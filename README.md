<!-- HEADER BANNER -->
<div align="center">
  <img src="./assets/Kurosaki Ichigo.gif" width="100%" />
...
| **Mod Minecraft Souls-like (FromSoftware)** | Bientôt terminé (hors modélisation 3D). | 🌗 |
| **App speed-run Elden Ring** | Presque prêt, reste mise en ligne. | 🌖 |
| **Site d’achat de bots Discord** | Prêt, reste déploiement. | 🌖 |
